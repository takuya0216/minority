...
class MTSSB_Front extends MTSSB_Booking {
    ...
    // 表示ページを固定ページにしたいとき
		//$this->this_page = "https://minority2017.com/sheet-reserve/";
	}
...
<?php
    ...
    //#my-day-calenderを追加。
		...
		if ($mark == 'vacant' || $mark == 'low') {
			echo $linkurl ? ('<a class="calendar-daylink" href="' . $linkurl . '#my-day-calender">') : '';
...
?>
	...
	?><div id="my-day-calender" class="day-calendar">
